 ...
 * Assignment: Lab 5
 * Date: 04/03/2023
 * Notes: This class represents an employee in a supervisory role. This means that this employee supervises at least one other employee
 */
...
public class Supervisor extends GenericEmployee {
    ...
    private final List<Employee> superviseeList;
