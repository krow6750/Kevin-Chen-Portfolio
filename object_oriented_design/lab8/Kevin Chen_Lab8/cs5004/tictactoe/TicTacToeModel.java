 ...
 * Assignment: Lab 8
 * Date: 04/17/2023
 * Notes: Class implementing TicTacToe interface. Represents the game board, with methods to reset
 *        the game board, display game board as a string, switch between players each turn, etc. 
 */
