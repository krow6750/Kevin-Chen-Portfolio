...
int unitTest4(){
    ...
    result = bst_find(testBST, 5) && bst_find(testBST, 3) && bst_find(testBST, 8) && 
             bst_find(testBST, 1) && bst_find(testBST, 7) && bst_find(testBST, 10);
    bst_free(testBST);
    return result;
}

// Test if the sum of nodes is correct
int unitTest5(){
    int result;
    bst_t * testBST = bst_create();
    bst_add(testBST, 5);
...
// Test the empty function with an empty BST
int unitTest6(){
    int result;
    bst_t * testBST = bst_create();
